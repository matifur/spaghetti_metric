...
def process_data(data):
    ...
    return unique_functions, chatgpt35Turbo_percent, llama_percent, chatgpt4o_percent

def plot_data(unique_functions, chatgpt35Turbo_percent, llama_percent, chatgpt4o_percent):
    # Wykres
...
if __name__ == "__main__":
    try:
        ...
        # Przetwórz dane
        unique_functions, chatgpt35Turbo_percent, llama_percent, chat4o_percent = process_data(data)

        # Generuj wykres
        plot_data(unique_functions, chatgpt35Turbo_percent, llama_percent, chat4o_percent)
